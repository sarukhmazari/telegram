...
export class DeliveryService {
     ...
     */
    static async processOrderDelivery(orderId, bot) {
        ...
        if (stockCount >= orderItem.quantity ||
    ...
    static async processAutomaticDelivery(order, orderItem, bot) {
    ...
    static async processManualDelivery(order, bot) {
    ...
    static async notifyCustomerDelivery(bot, telegramId, orderNumber, productName, items) {
        const telegramApi = bot.telegram || (typeof bot.sendMessage === 'function' ? bot : null);
        if (!telegramApi) {
