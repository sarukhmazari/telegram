...
export class UserService {
     ...
     */
    static async findOrCreateUser(telegramId, username, firstName, lastName, referralCodeArg) {
        const bigTelegramId = BigInt(telegramId);
        const isAdminConfigured = config.ADMIN_IDS.includes(bigTelegramId.toString());
        const expectedRole = isAdminConfigured ? Role.ADMIN : Role.USER;
     ...
     */
    static async updateBalance(userId, amount, type, description, referenceId) {
